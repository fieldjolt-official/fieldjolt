...
import { Input } from "@fieldjolt/ui/components/input";
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@fieldjolt/ui/components/sheet";
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@fieldjolt/ui/components/tooltip";
import { useIsMobile } from "@fieldjolt/ui/hooks/use-mobile";
import { cn } from "@fieldjolt/ui/lib/utils";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    // biome-ignore lint/nursery/noShadow: we good
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: we good
